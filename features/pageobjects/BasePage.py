...
class BasePage:
    ...
    def select(self, locator, value):
        ...
        if str(locator).endswith("_XPATH"):
            ...
            self.driver.find_element(By.CSS_SELECTOR, configReader.readConfig("locators", locator))
        elif str(locator).endswith("_ID"):
            self.driver.find_element(By.ID, configReader.readConfig("locators", locator))
        elif str(locator).endswith("_CLASS"):
